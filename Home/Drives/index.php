					...
					<div class="top-nav">
						...
						<ul class="nav1">
							<li class="hvr-sweep-to-bottom">
								<a href="../index.php">TPO-PIET<i>Goto Placement Homepage</i></a>
							</li>
					...
					<ul class="rslides" id="slider3">
						<li>
							<div class="banner-info">
								<h2  style="color:black">Do What you Love with
									<span>Passion</span>
								</h2>
								<div class="line"></div>
								<p></p>
						...
						<li>
							<div class="banner-info">
								<h2 style="color:black">Enrich your Brain with Sleek efforts like a
									<span>Paradise</span>
								</h2>
								<div class="line"></div>
								<p></p>
						...
						<li>
							<div class="banner-info">
								<h2 style="color:black">We have got all the things you need to be a
					...
					<div class="col-md-7 banner-bottom-grid-text">
						<div class="jumbotron banner-bottom-left wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;	">
							...
							<?php
                                        ...
                                        $sql = "SELECT * FROM add_drive ORDER by Id DESC LIMIT 1";
							...
							<div class="see-button">
							    	...
							    	<?php
                                        ...
                                        if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
                                        $start_from = ($page-1) * $num_rec_per_page;
                                        $sql = "SELECT GoogleFormLink FROM add_drive ORDER by Id DESC LIMIT 1";
                                        $rs_result = $conn->query($sql); //run the query
                                        // $rs_result = $sql->query();
                                        while ($row = $rs_result->fetch_assoc())
                                        {
                                        echo "<a class='btn btn-primary btn-lg see-button hvr-shutter-out-horizontal' href={$row['GoogleFormLink']} role='button'>See More</a>";
                                        }
                                    ?>
							</div>
						</div>
