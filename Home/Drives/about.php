...
<body>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of PIET</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers bachelors degree courses in 6 disciplines in Engineering viz. Computer Engineering and Civil.
					</p>
				</div>
		...
		<div class="container">
			<div class="team-info">
				...
				<div class="team-grids">
					...
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/janesh.jpeg" alt="">
						<h6>Janesh Kumar Chhaniwal</h6>
						<p>PHP Developer</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/lakshyajeet.jpeg" alt="">
						<h6>Lakshyajeet Solanki</h6>
