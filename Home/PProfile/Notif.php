              ...
              <div class="templatemo-content-widget Bluegrey-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Messages from Heads of Department.</p>  
                  </div>        
                </div>                
              </div>            
...
{ 
 ...
 if($query = $connect->query("INSERT INTO `id18835262_tpo_poornima`.`notification`(`Subject`,`Message`,`Sender`)
		VALUES ('$Subject', '$Message','$userType')")){
                      echo "";
		}
		else die();
} else
