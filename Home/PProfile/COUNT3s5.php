...
{ 
$Csslc = $_POST['csslc'];
$RESULT = mysql_query("SELECT count(*) FROM student_details WHERE `Approve`='1' AND SSLC>='$Csslc'");
$data = mysql_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Csslc' in SSLC&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysql_query("SELECT * FROM student_details WHERE `Approve`='1' AND SSLC>='$Csslc'");
