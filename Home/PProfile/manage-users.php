...
$sql = "SELECT * FROM student_details where Approve='1' ORDER BY ApprovalDate DESC LIMIT $start_from, $num_rec_per_page";
...
$connect = mysqli_connect('localhost','id18835262_tpo','Admin@123456', 'id18835262_tpo_poornima');
// mysql_select_db('id18835262_tpo_poornima');
$sql = "SELECT * FROM student_details where Approve='1' ";
$rs_result = $connect->query($sql); //run the query
