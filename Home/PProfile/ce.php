...
$sql = "SELECT * FROM student_details where Approve='1' and Branch='CE' LIMIT $start_from, $num_rec_per_page"; 
...
$sql_my = "SELECT * FROM student_details where Approve='1' and Branch='CE'"; 
