          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../index.php">Home PIET-PGC</a></li>
...
$num_rec_per_page=15;
$connect = mysqli_connect('localhost','id18835262_tpo','Admin@123456','id18835262_tpo_poornima');
// mysql_select_db('id18835262_tpo_poornima');
if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; };
$start_from = ($page-1) * $num_rec_per_page;
$sql = "SELECT * FROM student_details where Approve='1' DESC LIMIT $start_from, $num_rec_per_page";
...
$hisofbk = $_POST['hob'];
$dety = $_POST['dy'];
$sql = "SELECT * FROM student_details where Approve=1 and Branch='$branch' and SSLC>='$sslc' and `PU/Dip`>='$puaggregate' and BE>='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk' and DetainYears='$dety'" ;
 //run the query
...
$num_rec_per_page=15;
$connect_ = mysqli_connect('localhost','id18835262_tpo','Admin@123456','id18835262_tpo_poornima');
// mysql_select_db('id18835262_tpo_poornima');
$sql_ = "SELECT * FROM student_details where Approve='1'";
$rs_result_ = $connect->query($sql_); //run the query
$total_records = mysqli_num_rows($rs_result_);  //count number of records
