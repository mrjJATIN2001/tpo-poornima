...
$sql = "SELECT * FROM student_details where Approve='1' and Branch='Basic Science' LIMIT $start_from, $num_rec_per_page"; 
...
mysql_connect('localhost','id18835262_tpo','Admin@123456');
mysql_select_db('id18835262_tpo_poornima');
$sql = "SELECT * FROM student_details where Approve='1' and Branch='Basic Science'"; 
$rs_result = mysql_query($sql); //run the query
