      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <p>Placement Notifications</p>
            <form action="Notif.php" method="POST">
              <div class="row form-group">
                <div class="col-lg-12 form-group">
                    <label class="control-label" for="subject">Subject:</label>
                    <textarea class="form-control" name="subject" id="subject" rows="2"></textarea>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">
          ...
          <footer class="text-right">
           <p>Copyright &copy; 2022 PIET-PGC | Developed by <a href="#" target="_parent">Developed by Code Brigade </a></p>
          </footer>
        </div>
      </div>
    </div>
