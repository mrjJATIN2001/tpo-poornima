...
{ 
$Csem = $_POST['csem'];
$RESULT = mysql_query("SELECT count(*) FROM student_details WHERE `Approve`='1' AND Sem='$Csem'");
$data = mysql_fetch_assoc($RESULT);
echo "<br><h3>Students in Semister '$Csem'&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysql_query("SELECT * FROM student_details WHERE `Approve`='1' AND Sem='$Csem' ORDER BY Branch");
