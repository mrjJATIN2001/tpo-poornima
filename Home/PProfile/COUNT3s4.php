...
$RESULT = mysql_query("SELECT count(*) FROM student_details WHERE `Approve`='1' AND Branch='$Cbranch'");
$data = mysql_fetch_assoc($RESULT);
echo "<br><h3>Students in '$Cbranch' Branch&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>"; 
$sql = mysql_query("SELECT * FROM student_details WHERE `Approve`='1' AND Branch='$Cbranch' ORDER BY Sem");
