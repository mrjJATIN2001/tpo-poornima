...
$nameErr = $usernameErr = $passErr = $emailerr = $Qerr = $Anserr = "";
$Name = $Username = $password = $repassword = $Email = $Question = $Answer = "";
		...
		$check = mysql_query("SELECT * FROM student_login WHERE Username='".$Username."'") or die("Check Query");
 		if(mysql_num_rows($check) == 0)
 		{
   		...
   		else
   		{
			...
			$message = "This Username already exists/Dont Leave any Field Blank";
  			echo "<script type='text/javascript'>alert('$message');</script>";
