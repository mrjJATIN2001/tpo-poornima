    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
          ...
          <?php
		  $Welcome = "Welcome";
          echo "<h1>" . $Welcome . "<br>". $_SESSION['husername']. "</h1>"."<br>";echo "<h1>[</h1>";
...
$sql = "SELECT Subject, Message FROM notification where sender='TPO'";
...
?>
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2007-2022 PIET-PGC | 
			<a href="#" target="_parent">Developed by Code Brigade</a></p>
          </footer>
        </div>
      </div>
    </div>
